...
const SongSheetTop = () => {
  return (
    <View className='top_area' style={{ 'backgroundImage': `url(${songBg1}) cover no-repeat` }}>
      <View className='flex_row_cb song_sheet_detail'>
        <Image className='song_sheet_detail_cover' src={songBg1} />
        <View className='flex_column_sb song_content'>
          <View className='flex_column song_content_top'>
            ...
            <View className='create_man'>
              <Image className='create_man_img' src={songBg1} />
      ...
      <View className='like_message'></View>
    </View>
  )
}
